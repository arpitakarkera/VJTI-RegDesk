...
<div class="container">
	...
	<div class="form-group">
		...
		<!--event name-->
			...
			<div class="row">
			<div class="col-sm-4">
			<input class="form-control" type="text" name="event_name" value="<?php if(isset($event_name)) echo $event_name; ?>" required>
			</div>
			</div>
			<br>
		<!--description-->
			...
			<div class="row">
			<div class="col-sm-4">
			<textarea class="form-control" id="description" rows="4" cols="50" placeholder="Describe your event"><?php if(isset($description)) echo $description; ?></textarea>
			</div>
			</div>
		<br>
		<!--schedule-->
			...
			<div class="col-sm-4">
			<input class="form-control" type="time" name="end_time" value="<?php if(isset($end_time)) echo $end; ?>" id="end">
			</div>
			</div>
			<br>
			...
			<div class="row">
			<div class="col-sm-4">
			<input class="form-control" type="text" name="venue" value="<?php if(isset($venue)) echo $venue; ?>" required>
			</div>
			</div>
			<br>
			<!--incharge-->
			...
			<div class="row">
			<div class="col-sm-4">
			<input class="form-control" type="text" name="incharge1" placeholder="Incharge 1" value="<?php if(isset($incharge1)) echo $incharge1; ?>" required>
			</div>
			<div class="col-sm-4">
			<input class="form-control" type="text" name="contact1" placeholder="Contact number" value="<?php if(isset($contact1)) echo $contact1; ?>" required>
			</div>
			</div>
			...
			<div class="row">
			<div class="col-sm-4">
			<input class="form-control" type="text" name="incharge2" placeholder="Incharge 2" value="<?php if(isset($incharge2)) echo $incharge2; ?>">
			</div>
			<div class="col-sm-4">
			<input class="form-control" type="text" name="contact2" placeholder="Contact number" value="<?php if(isset($contact2)) echo $contact2; ?>">
			</div>
			</div>
			<br>
		...
		<!--details-->
			...
			<div class="row">
			<div class="col-sm-4">
			<input class="form-control" type="text" name="note" value="<?php if(isset($note)) echo $note; ?>">
			</div>
			</div>
			<br>
