...
<img src="../banners/<?php echo htmlspecialchars(str_pad($event['event_id'], 3, 0, STR_PAD_LEFT)) ?>.jpg" class="img img-responsive" style="padding-top:5%; vertical-align: middle;" width="160px" height="160px">
</div>
<div class="col-sm-6">
